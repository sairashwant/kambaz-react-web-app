export default function Lab1() {
    return (
      <div id="wd-lab1">
        <h2>Lab 1</h2>
        <h3>HTML Examples</h3>
        <h3>By: Sai Rashwant Venkataraman Sundaram</h3>
        <h3>Section 04</h3>
        <a href="https://github.com/sairashwant/kambaz-react-web-app">Github repo</a>
      <div id="wd-h-tag">
      <h4>Heading Tags</h4>
      ...
      My favorite recipe:
      <p>How to make Indian Filter Coffee:</p>
      <ol id="wd-your-favorite-recipe">
      <li>Boil Milk</li>
      <li>Add sugar</li>
      <li>Add filter coffee liquid</li>
      <li>Mix well</li>
      </ol>
      </div>
